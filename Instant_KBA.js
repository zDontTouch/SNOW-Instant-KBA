...
function downloadFavoriteList(){
  ...
  var csvFileContent = "data:text/csv;charset=utf-8,"+favoriteList;
  var encodedUri = encodeURI(csvFileContent);
  //create dummy 'a' element to programatically click it, then remove
  var dummyLink = document.createElement("a");
  dummyLink.setAttribute("href", encodedUri);
  dummyLink.setAttribute("download", "Express KBA Exported List");
  document.body.appendChild(dummyLink); 
  dummyLink.click();
  document.body.removeChild(dummyLink);
}

function uploadFavoriteList(){
    importedCsvFile = [];
    ...
    input.onchange = file => { 
      ...
      reader.onload = function(e) { 
          ...
          for(i=0; i<lines.length; i++){
            ...
            if(entry.length==2){
              //if valid KBA entry is detected (no incorrect CSV separators), create a new list and append all KBAs at the end
              kbasToAppend+="█"+entry[0]+"||"+entry[1];
            }else{
            }
          }
          localStorage.setItem("instant_kba_favorites",localStorage.getItem("instant_kba_favorites")+kbasToAppend);
          document.getElementById("favoriteList").innerHTML = loadFavoritesList(false);
     }
...
document.addEventListener("click", (e)=>{
  ...
  if(e.target.id == "bridgeButton"){
    ...
    var editButton = document.createElement("button");
    editButton.setAttribute("style","cursor:pointer; height:23px; position:absolute;right:10%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
    editButton.setAttribute("id","editList");
    editButton.innerHTML = "Edit List";
    ...
    exportButton.setAttribute("style","cursor:pointer; height:23px;  position:absolute;right:6%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
    exportButton.setAttribute("title","Export List");
    exportButton.setAttribute("id","exportList");
    exportButton.innerHTML = "⭳";
    bridgePopup.appendChild(exportButton);
    var importButton = document.createElement("button");
    importButton.setAttribute("style","cursor:pointer; height:23px;  position:absolute;right:2%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
    importButton.setAttribute("title","Import List");
  ...
  //Edit KBA list when it is open
    ...
    if(isListInEditMode){
      ...
      try{
        ...
        var editButton = document.createElement("button");
        editButton.setAttribute("style","cursor:pointer;  position:absolute;right:10%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
        editButton.setAttribute("id","editList");
        editButton.innerHTML = "Edit List";
        document.getElementById("favoriteList").appendChild(editButton);
        //import/export buttons
        ...
        exportButton.setAttribute("id","exportList");
        exportButton.innerHTML = "⭳";
        document.getElementById("favoriteList").appendChild(exportButton);
        var importButton = document.createElement("button");
        importButton.setAttribute("style","cursor:pointer; height:23px;  position:absolute;right:2%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
        importButton.setAttribute("title","Import List");
        importButton.setAttribute("id","importList");
        importButton.innerHTML = "↥";
        document.getElementById("favoriteList").appendChild(importButton);
      }catch(err){}
      isListInEditMode = false;
    }else{
      //open edit mode
      ...
      //import/export buttons
        ...
        exportButton.setAttribute("id","exportList");
        exportButton.innerHTML = "⭳";
        document.getElementById("bridgePopup").appendChild(exportButton);
        var importButton = document.createElement("button");
        importButton.setAttribute("style","cursor:pointer; height:23px;  position:absolute;right:2%;top:10px; background-color:RGB(var(--now-color_background--primary,var(--now-color--neutral-3,209,214,214)),var(--now-button--secondary--background-color-alpha--hover,var(--now-button--secondary--background-color-alpha,1))); border-color:RGB(var(--now-button--secondary--border-color,var(--now-color--neutral-7,135,147,148))); border-radius:var(--now-button--secondary--border-radius,var(--now-button--border-radius,var(--now-actionable--border-radius,0))); border-width:var(--now-button--secondary--border-width,var(--now-button--border-width,var(--now-actionable--border-width,1px))); color:RGB(var(--now-button--secondary--color,var(--now-color--neutral-18,22,27,28))); font-family: var(--now-button--font-family,var(--now-actionable--font-family,var(--now-font-family,\"Source Sans Pro\",Arial,sans-serif))); font-style:var(--now-button--font-style,var(--now-actionable--font-style,normal)); font-weight:var(--now-button--font-weight,var(--now-actionable--font-weight,normal)); font-size:0.85rem; line-weight:1.25;");
        importButton.setAttribute("title","Import List");
        importButton.setAttribute("id","importList");
        importButton.innerHTML = "↥";
        document.getElementById("bridgePopup").appendChild(importButton);
